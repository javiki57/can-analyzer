                        ...
                        if monitorizar_option == "Sí":
                            ...
                            while True:
                                ...
                                if ch == 27:  # Tecla 'Esc' para volver al menú principal
                                    ...
                                    stdscr.addstr(9, 2, "¿Qué interfaz vas a utilizar? (Por defecto vcan0):", COLOR_CYAN_BLACK)
                                    stdscr.addstr(10, 2, "Interfaz:", COLOR_CYAN_BLACK)
                                    curses.curs_set(1)
                                    interfaz_input = ""
                                    ...
                                    while True:
                                        ...
                                        if ch == 27:  # Tecla 'Esc' para volver al menú principal
                                            ...
                                            stdscr.move(10, 12)  # Mover el cursor a la posición correcta
                                            stdscr.clrtoeol()  # Borrar la línea actual desde la posición del cursor
                                            stdscr.addstr(10, 12, interfaz_input)  # Actualizar visualmente la interfaz
                                
                                        elif 0 <= ch <= 255:
                                            interfaz_input += chr(ch)
                                            stdscr.addstr(10, 12, interfaz_input)
                                            stdscr.refresh()
